...
function AnimateHeight(props) {
  ...
  return React.createElement(
    motion.div,
    {
      ...
      inherit: false,
      variants: variants,
      transition: { ease: ease, duration: computeDuration(height, duration) },
    },
...
function computeDuration(height, fixedDuration) {
  ...
  return (
    Math.round((4 + 10 * Math.pow(constant, 0.25) + constant / 5) * 10) / 1500
  );
}
...
var isDroppable = function (dragSource, dropTargetId, treeContext) {
  ...
  if (dragSource === null) {
    ...
    if (dragSourceNode === undefined || dragSourceId_1 === null) {
      return (
        dropTargetId === rootId ||
        !!(dropTargetNode === null || dropTargetNode === void 0
          ? void 0
...
var getInnerIndex = function (listItems, monitor) {
  ...
  listItems.forEach(function (el, key) {
    var _a;
    var flag = compareYCoord(
      el,
      ((_a = monitor.getClientOffset()) === null || _a === void 0
        ? void 0
        : _a.y) || 0
    );
    if (pos === "") {
...
var getOuterIndex = function (node, nodeEl, monitor) {
  ...
  var parentListItems =
    parentList === null || parentList === void 0
      ? void 0
      : parentList.querySelectorAll(':scope > [role="listitem"]');
  if (!parentListItems) {
    return null;
  }
...
var getDescendants = function (treeData, id) {
  ...
  var search = function (tree, ids) {
    ...
    if (children.length > 0) {
      descendants = __spreadArray(
        __spreadArray([], descendants, true),
        children,
        true
      );
      search(
...
var TreeProvider = function (props) {
  ...
  var value = __assign(
    ...
    {
      openIds: openIds,
      onDrop: function (dragSource, dropTargetId, placeholderIndex) {
        ...
        if (!dragSource) {
          ...
          if (!getTreeItem(tree, dragSource.id)) {
            tree = __spreadArray(
              __spreadArray([], tree, true),
              [dragSource],
              false
            );
          }
          if (props.sort === false) {
            var _a = getModifiedIndex(
                tree,
                dragSource.id,
                dropTargetId,
                placeholderIndex
      ...
      canDrop: canDropCallback
        ? function (dragSourceId, dropTargetId) {
            return canDropCallback(props.tree, {
              dragSourceId:
                dragSourceId !== null && dragSourceId !== void 0
                  ? dragSourceId
                  : undefined,
              dropTargetId: dropTargetId,
...
var useDropRoot = function (ref) {
  ...
  var _a = useDrop({
      accept: __spreadArray(
        [ItemTypes.TREE_ITEM],
        treeContext.extraAcceptTypes,
        true
      ),
...
var useOpenIdsHelper = function (tree, initialOpen) {
  ...
  var handleOpen = function (targetIds, callback) {
    var newOpenIds = __spreadArray(
      __spreadArray([], openIds, true),
      tree
        .filter(function (node) {
          return (
            node.droppable &&
...
var useContainerClassName = function (parentId, isOver) {
  var _a = useTreeContext(),
    ...
    classes = _a.classes;
  var className =
    (classes === null || classes === void 0 ? void 0 : classes.container) || "";
  if (
    isOver &&
    (classes === null || classes === void 0 ? void 0 : classes.dropTarget)
  ) {
...
var Node = function (props) {
  ...
  if (
    isDragging &&
    (classes === null || classes === void 0 ? void 0 : classes.draggingSource)
  ) {
  ...
  return React.createElement(
    Component,
    { ref: containerRef, className: className, role: "listitem" },
...
var Container = function (props) {
  ...
  if (treeContext.insertDroppableFirst) {
    ...
    if (treeContext.sort === false) {
      view = __spreadArray(
        __spreadArray([], droppableNodes, true),
        nonDroppableNodes,
        true
      );
    } else {
  ...
  return React.createElement(
    Component,
    __assign({ ref: ref, role: "list" }, rootProps, { className: className }),
